              ...
              <div key={course.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-500 mt-1">Academic Year: {course.academic_year}</p>
                  </div>
              ...
              {tests.slice(0, 3).map((test) => (
                <div key={test.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{test.duration_minutes} minutes</p>
                  </div>
                  <div className="text-right">
                    <span className="text-sm text-gray-500">{test.total_points} points</span>
            ...
            <div className="space-y-3">
              {answers.slice(0, 3).map((answer) => (
                <div key={answer.id} className="p-3 bg-gray-50 rounded-lg">
                  <h4 className="font-medium text-gray-900 line-clamp-2">{answer.answer}</h4>
                  <div className="flex items-center justify-between mt-2">
                    <span className="text-sm text-gray-600">Question ID: {answer.question_id}</span>
